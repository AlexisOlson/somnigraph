...
| [OpenClaw Penfield](https://github.com/penfieldlabs/openclaw-penfield) | openclaw-penfield.md | TypeScript client plugin for Penfield Labs' hosted SaaS backend with 3-channel hybrid search (BM25 + vector + graph), 24 typed relationship types, and tunable retrieval weights. |
