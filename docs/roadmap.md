...
7. **~~Reranker improvement: LambdaRank.~~** *(Negative result.)* Pointwise regressor outperforms LambdaRank by 1.3–1.6 NDCG points on both v1 and v2 GT. The data volume advantage (222k vs 52k samples) outweighs the better objective. Label discretization (continuous → quantile bins) also hurts. See `experiments.md` § Improvement experiments.
